...
#
#  $ bin/test -s ts16.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src ts16.theme.testing.TS16_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/ts16/theme/tests/robot/test_example.robot
#
